...
{
    //Skip birch speech and player naming 
    SetGpuReg(REG_OFFSET_DISPCNT, 0);
...
{
    return CreateMonPicSprite_Affine(SPECIES_BULBASAUR, FALSE, 0, MON_PIC_AFFINE_FRONT, x, y, 14, TAG_NONE);
}
