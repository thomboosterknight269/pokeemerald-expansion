...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_DUSKULL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_LEAF_STONE, SPECIES_DUSCLOPS}),
    },
    ...
    [SPECIES_SALAMENCE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_DRAGON),
        .abilities = { ABILITY_WIND_RIDER, ABILITY_SPEED_BOOST, ABILITY_GALE_WINGS },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Darehound"),
        .cryId = CRY_SALAMENCE,
        .natDexNum = NATIONAL_DEX_SALAMENCE,
        .categoryName = _("Fighter Jet"),
        .height = 15,
        .weight = 1026,
        .description = COMPOUND_STRING(
