...
const u32 gTrainerFrontPic_Nero[] = INCBIN_U32("graphics/trainers/front_pics/nero.4bpp.smol");
const u16 gTrainerPalette_Nero[] = INCBIN_U16("graphics/trainers/front_pics/nero.gbapal");

const u32 gTrainerFrontPic_Nora[] = INCBIN_U32("graphics/trainers/front_pics/nora.4bpp.smol");
const u16 gTrainerPalette_Nora[] = INCBIN_U16("graphics/trainers/front_pics/nora.gbapal");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_FRONT_NERO, gTrainerFrontPic_Nero, gTrainerPalette_Nero),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_NORA, gTrainerFrontPic_Nora, gTrainerPalette_Nora),
