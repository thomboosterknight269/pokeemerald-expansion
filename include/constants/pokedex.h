...
enum NationalDexOrder
{
    NATIONAL_DEX_NONE,
    // Kanto
    NATIONAL_DEX_SPOILEAF,
    NATIONAL_DEX_WICKOON,
    NATIONAL_DEX_FLORARCH,
    NATIONAL_DEX_KINTEN,
    NATIONAL_DEX_ALFLAME,
    NATIONAL_DEX_LOBLAZE,
    NATIONAL_DEX_SADROP,
    NATIONAL_DEX_AQUANGST,
    NATIONAL_DEX_DECEPHALO,
    NATIONAL_DEX_PEWPEK,
    NATIONAL_DEX_CAWLIBER,
    NATIONAL_DEX_BALLISTAQUILA,
    NATIONAL_DEX_PITCHICK,
    NATIONAL_DEX_TERRAXE,
    NATIONAL_DEX_HELLBIRD,
    NATIONAL_DEX_RATATO,
    NATIONAL_DEX_PROPATO,
    NATIONAL_DEX_DAISQUIRM,
    NATIONAL_DEX_KOKOROKUN,
    NATIONAL_DEX_AISHITERO,
